...
public class algorithms {
    ...
    public static boolean possibleNode_weigted(LinkedList<weightedNode> fathers, weightedNode node,
    ...
    public static Node evalFathers(LinkedList<Node> fathers, Node actualPosition, LinkedList<Integer> position,
            String operator) {
    ...
    public static weightedNode createWeigtedNode(weightedNode actualPosition, LinkedList<Integer> newPos,
            String operator, LinkedList<LinkedList<Integer>> matrix) {

        weightedNode node = new weightedNode(actualPosition, newPos, actualPosition.getState(), operator,
                actualPosition.getWeight());
    ...
    public static LinkedList<weightedNode> getSons_weigtedNode(LinkedList<LinkedList<Integer>> matrix,
    ...
    public static LinkedList<Node> getSons_node(LinkedList<LinkedList<Integer>> matrix, LinkedList<String> operators,
            Node actualPosition, boolean back) {
    ...
    public static LinkedList<String> AmplitudeSearch(LinkedList<LinkedList<Integer>> matrix,
            LinkedList<String> operators, boolean back) {
    ...
    public static LinkedList<LinkedList<String>> AmplitudeSearchPartial(LinkedList<LinkedList<Integer>> matrix,
            LinkedList<String> operators, boolean back) {
    ...
    public static LinkedList<String> DeepSearch(LinkedList<LinkedList<Integer>> matrix, LinkedList<String> operators,
            boolean back) {
    ...
    public static LinkedList<LinkedList<String>> DeepSearchPartial(LinkedList<LinkedList<Integer>> matrix,
            LinkedList<String> operators, boolean back) {
    ...
    public static LinkedList<String> uniformCostSearch(LinkedList<LinkedList<Integer>> matrix,
            LinkedList<String> operators, boolean back) {
    ...
    public static LinkedList<LinkedList<String>> uniformCostSearchPartial(LinkedList<LinkedList<Integer>> matrix,
            LinkedList<String> operators, boolean back) {
    ...
    public static LinkedList<String> AvaraSearch(LinkedList<LinkedList<Integer>> matrix, LinkedList<String> operators,
            boolean back) {

        // Cola que se utilizará para la ejecución del algoritmo
        LinkedList<Node> queue = new LinkedList<>();
        // PriorityQueue<weightedNode> queue = new
        // PriorityQueue<>(Comparator.comparingInt(weightedNode::getWeight));
    ...
    public static LinkedList<String> AStarSearch(LinkedList<LinkedList<Integer>> matrix, LinkedList<String> operators,
            boolean back) {
    ...
    // Se agrega esta clase adicional para manejar resultados:
    ...
    public static class SearchResult {
        ...
        public SearchResult(LinkedList<String> path, int nodesExpanded, int depth, long executionTime, int cost) {
            this.path = path;
